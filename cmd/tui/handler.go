...
func (i *InputHandler) AskBoolWarn(question string, warning string, defaultAnswer bool) (bool, error) {
...
func (i *InputHandler) AskStringWarn(question string, warning string, defaultAnswer string, validator func(string) error) (string, error) {
	i.printWarning(warning)
