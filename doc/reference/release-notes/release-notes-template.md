...
myst:
  html_meta:
    description: Release notes for MicroCloud x.y, including highlights about new features, bugfixes, and other updates from the MicroCloud project.
---

(ref-release-notes-x.y)=
# MicroCloud x.y release notes
...
View the [complete list of all changes in this release](https://github.com/canonical/microcloud/compare/microcloud-a.b...microcloud-x.y).
