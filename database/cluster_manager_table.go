...
//go:generate mapper method -i -d github.com/canonical/microcluster/v2/cluster -e ClusterManagerConfig ID table=cluster_manager
...
//go:generate mapper method -i -d github.com/canonical/microcluster/v2/cluster -e ClusterManagerConfig DeleteOne-by-ClusterManagerID table=cluster_manager_config
